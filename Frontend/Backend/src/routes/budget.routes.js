...
router.patch('/:id/status', validate(budgetIdParamSchema, 'params'), validate(updateBudgetStatusSchema), updateBudgetStatus);
...
router.post('/approvals/:id/approve', validate(budgetIdParamSchema, 'params'), validate(approveBudgetSchema), approveBudget);
