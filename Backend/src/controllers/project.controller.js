  ...
  try {
    ...
    const statistics = {
      tasks: {
        ...
        total: tasksByStatus.reduce((sum, item) => sum + item._count, 0),
      },
      expenses: {
      ...
      budget: {
        ...
        remaining: project.estimatedBudget - (totalExpenses._sum.amount || 0),
        utilizationRate:
          project.estimatedBudget > 0
            ? ((totalExpenses._sum.amount || 0) / project.estimatedBudget) * 100
            : 0,
      },
    };
